...
DROP FUNCTION IF EXISTS public.log_trial_balance_upload(text,integer,uuid,jsonb);

-- Create insert_trial_balance_data function to work with new table
...
-- Create log_trial_balance_upload function
...
BEGIN
  ...
  -- Log to security audit logs for tracking
  PERFORM log_security_event(
    'trial_balance_file_upload',
    current_user_uuid,
    jsonb_build_object(
