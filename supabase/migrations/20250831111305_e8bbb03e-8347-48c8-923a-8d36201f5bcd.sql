-- Drop and recreate database functions with proper SET search_path = 'public'
...
-- Update existing log_security_event function with proper security
...
CREATE OR REPLACE FUNCTION public.validate_user_input(input_data jsonb, validation_rules jsonb)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path = 'public'
