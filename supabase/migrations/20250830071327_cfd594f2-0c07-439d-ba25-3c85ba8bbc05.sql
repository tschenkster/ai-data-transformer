-- Drop all existing functions that need search_path fixes
DROP FUNCTION IF EXISTS public.enhanced_check_rate_limit;
DROP FUNCTION IF EXISTS public.enhanced_log_security_event;
