...
-- First, let's create temporary backup tables
...
-- Drop and recreate with proper column order and naming
...
INSERT INTO report_line_items (
    ...
    description_of_leaf, is_leaf, is_calculated, display, data_source,
    CASE WHEN comment IS NOT NULL THEN comment::text ELSE NULL END
)
SELECT 
