-- Drop the incorrectly named singular table and its associated objects
DROP POLICY IF EXISTS "Users can view trial balance data for entities they have access to" ON data.trial_balance_uploaded;
DROP POLICY IF EXISTS "Admins can insert trial balance data" ON data.trial_balance_uploaded;
DROP POLICY IF EXISTS "Admins can update trial balance data" ON data.trial_balance_uploaded;
DROP POLICY IF EXISTS "Admins can delete trial balance data" ON data.trial_balance_uploaded;

DROP INDEX IF EXISTS data.idx_trial_balance_uploaded_entity_uuid;
DROP INDEX IF EXISTS data.idx_trial_balance_uploaded_period_key;
DROP INDEX IF EXISTS data.idx_trial_balance_uploaded_account_number;

DROP TABLE IF EXISTS data.trial_balance_uploaded;
