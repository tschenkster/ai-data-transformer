-- Fix the translation fallback logic - original text should come before other language fallbacks
...
BEGIN
  ...
  -- CRITICAL FIX: Return original text BEFORE trying other language fallbacks
  -- This ensures that when requesting English, we get the original English text if no translation exists
