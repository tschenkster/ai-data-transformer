...
-- Phase 4: Drop existing functions that need return type changes
DROP FUNCTION IF EXISTS public.get_users_by_status(user_account_status);
...
-- Phase 5: Recreate functions with updated column references
...
-- Update other functions that reference the old columns
