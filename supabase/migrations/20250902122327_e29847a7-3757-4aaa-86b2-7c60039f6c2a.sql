-- First, update existing invalid source values to match the constraint
...
-- Now add the check constraints that allow the correct values
  ...
  LOOP
    ...
    IF p_entity_type = 'report_structure' THEN
      INSERT INTO report_structures_translations (
        ...
        text_value, -- Use same as original for AI translations
        'ai_generated'
      )
