-- Fix translation system configuration and add missing Hero translations (Fixed)

-- Step 1: Fix system language defaults (German should be default)
-- First set all to false, then set German to true to avoid unique constraint violation
