...
-- Phase 3: Recreate report_structures with correct column order
...
-- Phase 4: Recreate report_line_items with correct column order
...
-- Phase 5: Restore data from backup tables
...
-- Phase 6: Recreate constraints and indexes
...
-- Phase 8: Recreate RLS policies for report_structures
...
-- Phase 9: Recreate RLS policies for report_line_items
...
-- Phase 11: Update sequence values to current max
...
-- Phase 12: Clean up backup tables
