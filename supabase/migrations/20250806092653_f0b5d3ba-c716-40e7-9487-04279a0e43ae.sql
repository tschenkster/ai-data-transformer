-- Drop the conflicting sequences first
DROP SEQUENCE IF EXISTS report_structures_report_structure_id_seq CASCADE;
DROP SEQUENCE IF EXISTS report_line_items_report_line_item_id_seq CASCADE;

-- Create new tables with correct column order
...
-- Copy data from old tables to new tables using OVERRIDING SYSTEM VALUE
