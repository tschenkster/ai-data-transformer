  ...
  const fetchData = async () => {
    try {
      ...
      if (isSuperAdmin) {
        ...
        const [groupsResponse, entitiesResponse] = await Promise.all([
        ...
        // Entity admins can see their entities
        if (currentEntity) {
          const entityResponse = await supabase.from('entities')
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage entities and entity groups
        </CardDescription>
      </CardHeader>
      <CardContent>
