...
// Operate and configure the platform: entities, settings, maintenance, and observability
// Entity & environment configuration, global settings, backups, health checks, monitoring
