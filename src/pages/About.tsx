            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {[
                  ...
                  { name: "Google AI Studio", category: "Gen AI Dev Platform", favicon: "/tool-logos/gemini-favicon.png" },
                  ...
                  { name: "BOARD", category: "Business Intelligence", favicon: "/tool-logos/board-favicon-new.png" },
