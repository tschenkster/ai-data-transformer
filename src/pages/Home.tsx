  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="relative z-10 -mt-4">
          ...
          <div className="max-w-5xl mx-auto text-center space-y-12">
            <div className="animate-fade-in space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                You need board-ready insights, You're stuck with DATEV outputs that tell you nothing useful and Excel sheets that break every time you breathe on them.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Persona Section */}
        <section className="bg-gradient-subtle/30 py-12 md:py-16">
          <div className="container mx-auto px-4">
        ...
        <section className="bg-gradient-subtle/30 py-8 md:py-12">
          <div className="container mx-auto px-4">
